...
df_torneos2 <- df_torneos2 %>%
    mutate(pts_nuevo = ifelse((year >= 1995),pts,((pg*3)+pe)),
           ...
           year = factor(year,levels = c(1950:2013,'2013-14','2014-15','2015-16','2016-17',2017:2020)),
           camp = case_when((year %in% c(1950:1967,1971:1983,1985:2001,2010,2013,2017:2020))& (pos == 1)~'C',
...
# Inicio shiny
ui <- navbarPage("Fútbol chileno. 1950-2020.",
    ...
    # Barra lateral
        sidebarPanel(
            selectInput("year",
                        "Escoja un año",
                        choices = c(1950:2013,'2013-14','2014-15','2015-16','2016-17',2017:2018,2020),
                        selected = "1950"),
            width = 2
        ),
        ...
        mainPanel(
            ...
            h6("No se incluye el torneo posterior a 2018 por su desarrollo irregular")
        )),
